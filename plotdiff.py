...
print('Average Offset %4.1f %4.1f (arc seconds)' % (numpy.average(x_offset[selection]),numpy.average(y_offset[selection])))
...
plt.savefig("%s_%s.pdf" % (options.file1.replace(".sds","").replace("/","_"),options.file2.replace(".sds","").replace("/","_")))
plt.show()
plt.close()
